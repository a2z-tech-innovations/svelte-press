...
<svelte:head>
	<title>Category: {data.category.name} &ndash; {data.siteName}</title>
...
<div class="fp-archive">
	<header class="fp-archive-header">
		<div class="fp-archive-label">Category</div>
		<h1 class="fp-archive-title">{data.category.name}</h1>
		{#if data.category.description}
			<p class="fp-archive-description">{data.category.description}</p>
		{/if}
