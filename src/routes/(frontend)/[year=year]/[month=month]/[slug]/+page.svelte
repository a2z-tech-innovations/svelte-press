...
<style>
	...
	.fp-single-content :global(code) { font-family: 'Fira Code', Consolas, monospace; font-size: 0.875em; }
	...
	.fp-tag { display: inline-block; padding: 0.2rem 0.6rem; border: 1px solid #c3c4c7; border-radius: 2rem; font-size: 0.75rem; color: #646970; text-decoration: none; }
	...
	.fp-author-name { display: block; font-size: 1rem; font-weight: 700; color: #1d2327; text-decoration: none; margin-bottom: 0.25rem; }
